...
// Point::clone()
// Point::distanceTo(p)
// Stroke::createStrokePoint(x, y, t)
// Stroke::fromOneDArray(arr, hasTimeStamp)
// Stroke::fromArray(arr)
// Stroke::clearCache()
// Stroke::clone()
// Stroke::copy(stroke)
...
// Stroke::getCorners()
// Stroke::distanceTo(stroke)
// Stroke::distanceAtAngle(stroke, angleInRadians)
// Stroke::distanceAtBestAngle(stroke, a, b, threshold)
// Stroke::optimalCosineDistance(stroke)
// Stroke::reverse()
// Stroke::flipX()
// Stroke::flipY()
// Stroke::resample(n)
...
var shortStraw = require('./shortStraw');
...
Stroke.NUM_OF_SAMPLE_POINTS = 64;
Stroke.prototype.resample = function(n) {

  n || (n = Stroke.NUM_OF_SAMPLE_POINTS);
  var points = this.points;
  var createStrokePoint = this.createStrokePoint;
